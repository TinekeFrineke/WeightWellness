...
Generator::XmlClass::eRESULT XmlVoedingsmiddeldefsReader::Read(const std::wstring & aFilename, XmlVoedingsmiddeldefs *& aVoedingsmiddeldefs)
{
...
Generator::XmlClass::eRESULT XmlVoedingsmiddeldefsReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlVoedingsmiddeldefs & aVoedingsmiddeldefs)
{
