...
Generator::XmlClass::eRESULT XmlUnitsReader::Read(const std::wstring & aFilename, XmlUnits *& aUnits)
{
  aUnits = NULL;
...
Generator::XmlClass::eRESULT XmlUnitsReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlUnits & aUnits)
{
