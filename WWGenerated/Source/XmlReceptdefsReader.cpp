...
Generator::XmlClass::eRESULT XmlReceptdefsReader::Read(const std::wstring & aFilename, XmlReceptdefs *& aReceptdefs)
{
  aReceptdefs = NULL;
...
Generator::XmlClass::eRESULT XmlReceptdefsReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlReceptdefs & aReceptdefs)
{
