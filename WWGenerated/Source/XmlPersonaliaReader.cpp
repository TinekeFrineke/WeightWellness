...
Generator::XmlClass::eRESULT XmlPersonaliaReader::Read(const std::wstring & aFilename, XmlPersonalia *& aPersonalia)
{
  aPersonalia = NULL;
...
Generator::XmlClass::eRESULT XmlPersonaliaReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlPersonalia & aPersonalia)
{
