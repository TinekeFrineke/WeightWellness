...
Generator::XmlClass::eRESULT XmlBonuslistReader::Read(const std::wstring & aFilename, XmlBonuslist *& aBonuslist)
{
  aBonuslist = NULL;
...
Generator::XmlClass::eRESULT XmlBonuslistReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlBonuslist & aBonuslist)
{
