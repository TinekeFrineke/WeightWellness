...
Generator::XmlClass::eRESULT XmlGerechtdefsReader::Read(const std::wstring & aFilename, XmlGerechtdefs *& aGerechtdefs)
{
  aGerechtdefs = NULL;
...
Generator::XmlClass::eRESULT XmlGerechtdefsReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlGerechtdefs & aGerechtdefs)
{
