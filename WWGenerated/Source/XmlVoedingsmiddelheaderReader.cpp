...
Generator::XmlClass::eRESULT XmlVoedingsmiddelheaderReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlVoedingsmiddelheader & aVoedingsmiddelheader)
{
